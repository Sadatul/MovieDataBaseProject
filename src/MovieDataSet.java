...
public class MovieDataSet {
    ...
    private long totalIndustryRevenue;
    ...
    String searchExactCompanyName(String production_company)
    {
        for (Movie x : moviesListByName) {
            if (x.getProduction_company().equalsIgnoreCase(production_company)) {
                return x.getProduction_company();
            }
        }
        return null;
    }
...
//        addedMovieList.add(movie);
        ...
        size++;
        totalIndustryRevenue += (movie.getRevenue());
    }

    public Long getTotalIndustryRevenue() {
        return totalIndustryRevenue;
    }
    ...
    void close() throws Exception
    {
        ...
        for (Movie movie: moviesListByName)
        {
